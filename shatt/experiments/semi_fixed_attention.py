...
RESULT_FIXED_ATTENTION_NAME = "attention_semi"
...
def start_semi_fixed_attention(model, sequence, results, target_path):
        processed_count = 0
...
def start_semi_fixed_attention_from_config(config, path_to_model, target_split, target_path, input_iterations):
    ...
    start_semi_fixed_attention(model, sequence, results, target_path)
