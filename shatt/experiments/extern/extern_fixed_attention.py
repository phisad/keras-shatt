...
RESULT_EXTERN_ATTENTION_NAME = "attention_extern_fixed"
...
def start_extern_fixed_attention(model, sequence, results, target_path):
        processed_count = 0
        ...
        try:
            ...
            results.write_results_file(target_path, file_infix=RESULT_EXTERN_ATTENTION_NAME)
        except Exception as e:
            print("Exception: ", e)

            
def start_extern_fixed_attention_from_config(config, path_to_model, target_split, target_path):
    ...
    start_extern_fixed_attention(model, sequence, results, target_path)
