...
RESULT_FIXED_ATTENTION_NAME = "attention_extern_dynamic"
...
def start_extern_dynamic_attention(model, sequence, results, target_path):
        processed_count = 0
...
def start_extern_dynamic_attention_from_config(config, path_to_model, target_split, target_path, input_weight):
    ...
    start_extern_dynamic_attention(model, sequence, results, target_path)
